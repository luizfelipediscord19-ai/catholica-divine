...
const PAGINAS: ItemBusca[] = [
  {
    id: "p-fe",
    titulo: "A Fé Católica",
    descricao: "Credo, Revelação, Tradição e Magistério",
    categoria: "Página",
    href: "/fe-catolica",
  },
  {
    ...
    descricao: "73 livros com introdução e texto por capítulo",
    categoria: "Página",
    href: "/biblia",
  },
  {
    id: "p-leituras",
    titulo: "Leituras da Bíblia",
    descricao: "Planos e roteiros de leitura bíblica",
    categoria: "Página",
    href: "/biblia/leituras",
  },
  {
    id: "p-catecismo",
    titulo: "Catecismo da Igreja Católica",
    descricao: "As quatro partes do CIC",
    categoria: "Página",
    href: "/catecismo",
  },
  {
    id: "p-sacramentos",
    titulo: "Sacramentos",
    descricao: "Os sete sacramentos da Igreja",
    categoria: "Página",
    href: "/sacramentos",
  },
  {
    id: "p-santos",
    titulo: "Santos",
    descricao: "Vidas dos santos e bem-aventurados",
    categoria: "Página",
    href: "/santos",
  },
  {
    ...
    descricao: "Os 37 doutores e suas obras",
    categoria: "Página",
    href: "/doutores-da-igreja",
  },
  {
    id: "p-maria",
    titulo: "Maria",
    descricao: "Dogmas marianos, aparições e devoções",
    categoria: "Página",
    href: "/maria",
  },
  {
    id: "p-oracoes",
    titulo: "Orações",
    descricao: "Rosário, Via-Sacra, novenas, Liturgia das Horas",
    categoria: "Página",
    href: "/oracoes",
  },
  {
    ...
    descricao: "Mistérios gozosos, luminosos, dolorosos e gloriosos",
    categoria: "Oração",
    href: "/oracoes/rosario",
  },
  {
    id: "p-viasacra",
    titulo: "Via-Sacra",
    descricao: "As catorze estações da Paixão",
    categoria: "Oração",
    href: "/oracoes/via-sacra",
  },
  {
    id: "p-misericordia",
    titulo: "Terço da Divina Misericórdia",
    descricao: "Devoção revelada a Santa Faustina",
    categoria: "Oração",
    href: "/oracoes/terco-misericordia",
  },
  {
    id: "p-horas",
    titulo: "Liturgia das Horas",
    descricao: "Ofício Divino: Laudes, Vésperas, Completas",
    categoria: "Oração",
    href: "/oracoes/liturgia-das-horas",
  },
  {
    id: "p-novenas",
    titulo: "Novenas",
    descricao: "Novenas tradicionais dia por dia",
    categoria: "Oração",
    href: "/oracoes/novenas",
  },
  {
    id: "p-apologetica",
    titulo: "Apologética",
    descricao: "Respostas às objeções mais comuns",
    categoria: "Página",
    href: "/apologetica",
  },
  {
    ...
    descricao: "Tempos, cores e solenidades do ano",
    categoria: "Página",
  ...
  },
  {
    ...
    descricao: "Leituras e Evangelho de hoje",
    categoria: "Página",
  ...
  },
  {
    id: "p-coroinhas",
    titulo: "Coroinhas",
    descricao: "Formação para acólitos e ministrantes",
    categoria: "Página",
    href: "/coroinhas",
  },
  {
    id: "p-glossario",
    titulo: "Glossário Católico",
    descricao: "Termos doutrinais explicados",
    categoria: "Página",
    href: "/glossario",
  },
  {
  ...
  },
  {
    id: "p-painel",
    titulo: "Meu Painel",
    descricao: "Progresso espiritual, diário e conquistas",
    categoria: "Página",
    href: "/painel",
  },
  {
    ...
    descricao: "Cruze Bíblia, Catecismo e Magistério em uma consulta",
    categoria: "Página",
    href: "/busca",
  },
  {
    ...
    descricao: "Critérios teológicos, fontes e processo de revisão editorial",
    categoria: "Página",
    href: "/sobre",
  },
  {
    id: "p-sophia",
    titulo: "Sophia IA",
    descricao: "Assistente católico para suas dúvidas",
    categoria: "Página",
    href: "/assistente",
  },
];
...
export function indiceBusca(): ItemBusca[] {
  ...
  const slugPorParte: Record<number, string> = {
    1: "credo",
    2: "liturgia",
    3: "vida-em-cristo",
    4: "oracao",
