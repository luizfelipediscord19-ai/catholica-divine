...
export const PAGINAS: SitemapEntry[] = [
  ...
  { path: "/doutrina/pecado-original", changefreq: "monthly", priority: "0.7" },
  { path: "/doutrina/morte-e-ressurreicao", changefreq: "monthly", priority: "0.7" },
  ...
  { path: "/testemunhos", changefreq: "weekly", priority: "0.7" },
