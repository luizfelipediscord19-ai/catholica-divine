...
export const LIVROS: Livro[] = [
  // Pentateuco
  { slug: "genesis", nome: "Gênesis", abrev: "Gn", capitulos: 50, testamento: "AT", grupo: "Pentateuco", autor: "Tradição mosaica", data: "séc. XIII–V a.C.", resumo: "A criação do mundo, a queda, os patriarcas Abraão, Isaac, Jacó e a história de José no Egito." },
  { slug: "exodo", nome: "Êxodo", abrev: "Ex", capitulos: 40, testamento: "AT", grupo: "Pentateuco", autor: "Tradição mosaica", data: "séc. XIII–V a.C.", resumo: "A libertação de Israel da escravidão no Egito, a aliança no Sinai e o Decálogo." },
  { slug: "levitico", nome: "Levítico", abrev: "Lv", capitulos: 27, testamento: "AT", grupo: "Pentateuco", autor: "Tradição mosaica", data: "séc. VI a.C.", resumo: "Leis cultuais, sacerdócio levítico e código de santidade." },
  { slug: "numeros", nome: "Números", abrev: "Nm", capitulos: 36, testamento: "AT", grupo: "Pentateuco", autor: "Tradição mosaica", data: "séc. VI a.C.", resumo: "Quarenta anos de peregrinação de Israel no deserto." },
  { slug: "deuteronomio", nome: "Deuteronômio", abrev: "Dt", capitulos: 34, testamento: "AT", grupo: "Pentateuco", autor: "Tradição mosaica", data: "séc. VII a.C.", resumo: "Os últimos discursos de Moisés e a renovação da aliança." },
  ...
  { slug: "salmos", nome: "Salmos", abrev: "Sl", capitulos: 150, testamento: "AT", grupo: "Sapienciais", autor: "Davi e outros", data: "séc. X–III a.C.", resumo: "Os 150 cânticos da oração de Israel — o livro de orações de Cristo e da Igreja." },
  { slug: "proverbios", nome: "Provérbios", abrev: "Pr", capitulos: 31, testamento: "AT", grupo: "Sapienciais", autor: "Salomão e outros", data: "séc. X–IV a.C.", resumo: "Coleção de máximas sapienciais." },
  ...
  // Proféticos
  { slug: "isaias", nome: "Isaías", abrev: "Is", capitulos: 66, testamento: "AT", grupo: "Proféticos", autor: "Isaías e discípulos", data: "séc. VIII–VI a.C.", resumo: "O ‘evangelho do Antigo Testamento’ — anuncia o Emanuel e o Servo Sofredor." },
  ...
  // Evangelhos
  { slug: "mateus", nome: "Mateus", abrev: "Mt", capitulos: 28, testamento: "NT", grupo: "Evangelhos", autor: "São Mateus Apóstolo", data: "c. 70 d.C.", resumo: "Cristo, novo Moisés, cumpre as Escrituras. Sermão da Montanha." },
  { slug: "marcos", nome: "Marcos", abrev: "Mc", capitulos: 16, testamento: "NT", grupo: "Evangelhos", autor: "São Marcos Evangelista", data: "c. 65 d.C.", resumo: "Cristo, Filho de Deus revelado pela cruz. O mais breve dos Evangelhos." },
  { slug: "lucas", nome: "Lucas", abrev: "Lc", capitulos: 24, testamento: "NT", grupo: "Evangelhos", autor: "São Lucas Evangelista", data: "c. 80 d.C.", resumo: "Cristo, salvador dos pobres e dos pecadores. Contém o Magnificat e o Benedictus." },
  { slug: "joao", nome: "João", abrev: "Jo", capitulos: 21, testamento: "NT", grupo: "Evangelhos", autor: "São João Apóstolo", data: "c. 95 d.C.", resumo: "Cristo, Verbo encarnado. Os sete sinais e os grandes discursos." },
  ...
  { slug: "efesios", nome: "Efésios", abrev: "Ef", capitulos: 6, testamento: "NT", grupo: "Cartas Paulinas", autor: "São Paulo", data: "c. 62 d.C.", resumo: "Mistério da Igreja como Corpo de Cristo." },
  ...
  { slug: "colossenses", nome: "Colossenses", abrev: "Cl", capitulos: 4, testamento: "NT", grupo: "Cartas Paulinas", autor: "São Paulo", data: "c. 62 d.C.", resumo: "Primado cósmico de Cristo." },
  ...
  { slug: "2tessalonicenses", nome: "2 Tessalonicenses", abrev: "2Ts", capitulos: 3, testamento: "NT", grupo: "Cartas Paulinas", autor: "São Paulo", data: "c. 52 d.C.", resumo: "Sobre a vinda do Senhor e a Tradição apostólica." },
  { slug: "1timoteo", nome: "1 Timóteo", abrev: "1Tm", capitulos: 6, testamento: "NT", grupo: "Cartas Paulinas", autor: "São Paulo", data: "c. 64 d.C.", resumo: "Pastoral: organização da Igreja." },
  { slug: "2timoteo", nome: "2 Timóteo", abrev: "2Tm", capitulos: 4, testamento: "NT", grupo: "Cartas Paulinas", autor: "São Paulo", data: "c. 67 d.C.", resumo: "Testamento espiritual de Paulo." },
  { slug: "tito", nome: "Tito", abrev: "Tt", capitulos: 3, testamento: "NT", grupo: "Cartas Paulinas", autor: "São Paulo", data: "c. 64 d.C.", resumo: "Pastoral: ordenação de presbíteros." },
  ...
  { slug: "hebreus", nome: "Hebreus", abrev: "Hb", capitulos: 13, testamento: "NT", grupo: "Cartas Paulinas", autor: "Atribuída a São Paulo", data: "c. 70 d.C.", resumo: "Cristo, Sumo Sacerdote eterno." },

  // Católicas
  { slug: "tiago", nome: "Tiago", abrev: "Tg", capitulos: 5, testamento: "NT", grupo: "Cartas Católicas", autor: "São Tiago", data: "c. 50 d.C.", resumo: "Fé e obras — a sabedoria prática cristã." },
  { slug: "1pedro", nome: "1 Pedro", abrev: "1Pd", capitulos: 5, testamento: "NT", grupo: "Cartas Católicas", autor: "São Pedro", data: "c. 64 d.C.", resumo: "Esperança cristã na perseguição." },
  { slug: "2pedro", nome: "2 Pedro", abrev: "2Pd", capitulos: 3, testamento: "NT", grupo: "Cartas Católicas", autor: "São Pedro", data: "c. 67 d.C.", resumo: "Contra os falsos mestres." },
  { slug: "1joao", nome: "1 João", abrev: "1Jo", capitulos: 5, testamento: "NT", grupo: "Cartas Católicas", autor: "São João Apóstolo", data: "c. 95 d.C.", resumo: "‘Deus é amor.’ Comunhão com o Pai e com o Filho." },
  { slug: "2joao", nome: "2 João", abrev: "2Jo", capitulos: 1, testamento: "NT", grupo: "Cartas Católicas", autor: "São João Apóstolo", data: "c. 95 d.C.", resumo: "Permanecer na verdade e no amor." },
  { slug: "3joao", nome: "3 João", abrev: "3Jo", capitulos: 1, testamento: "NT", grupo: "Cartas Católicas", autor: "São João Apóstolo", data: "c. 95 d.C.", resumo: "Bilhete pessoal a Gaio." },
  { slug: "judas", nome: "Judas", abrev: "Jd", capitulos: 1, testamento: "NT", grupo: "Cartas Católicas", autor: "São Judas", data: "c. 65 d.C.", resumo: "Combate aos falsos mestres." },

  // Apocalipse
  { slug: "apocalipse", nome: "Apocalipse", abrev: "Ap", capitulos: 22, testamento: "NT", grupo: "Apocalipse", autor: "São João Apóstolo", data: "c. 95 d.C.", resumo: "Visão da vitória final do Cordeiro e da Nova Jerusalém." },
];
