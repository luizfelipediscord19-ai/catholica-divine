...
export const INTRODUCOES: Record<string, Introducao> = {
  ...
  levitico: {
    contexto: "Código sacerdotal de santidade e culto (terceiro livro da Torá), atribuído à tradição mosaica mas redigido em sua forma final pela escola sacerdotal no pós-exílio (séc. VI a.C.). Gênero legislativo-ritual, organizado em torno dos sacrifícios (1–7), da consagração dos sacerdotes (8–10), das leis de pureza (11–15) e do código de santidade (17–26). Concentra-se na santidade ritual e moral do povo da aliança, mediada pelo sacerdócio levítico.",
    temas: ["Santidade de Deus comunicada ao povo", "Sacrifícios e mediação sacerdotal", "Pureza e expiação", "Calendário litúrgico"],
    passagens: ["Lv 11,44 — ‘Sede santos, porque eu sou santo’", "Lv 16 — Dia do Yom Kippur", "Lv 19,18 — ‘Amarás teu próximo como a ti mesmo’", "Lv 25,10 — Ano jubilar, libertação e restituição"],
  ...
  josue: {
    ...
    passagens: ["Js 1,9 — ‘Sê forte e corajoso’", "Js 3,17 — Travessia do Jordão em terra seca", "Js 24,15 — ‘Eu e a minha casa serviremos ao Senhor’"],
  ...
  "1samuel": {
    ...
    passagens: ["1Sm 1,27 — Oração de Ana por um filho", "1Sm 3,10 — ‘Fala, Senhor, teu servo escuta’", "1Sm 16,7 — ‘O Senhor vê o coração’"],
  ...
  "2samuel": {
    ...
    passagens: ["2Sm 6,14-15 — Davi dança diante da Arca", "2Sm 7,12-14 — Oráculo de Natã: trono eterno", "2Sm 12,13 — ‘Pequei contra o Senhor’"],
  ...
  "1reis": {
    ...
    passagens: ["1Rs 3,9 — Pedido de Salomão por sabedoria", "1Rs 8,10-11 — Nuvem da glória enche o Templo", "1Rs 19,12 — Deus na brisa suave"],
  ...
  "2reis": {
    ...
    passagens: ["2Rs 2,11 — Elias arrebatado", "2Rs 5,14 — Cura de Naamã, o sírio", "2Rs 25 — Queda de Jerusalém"],
  ...
  "1cronicas": {
    ...
    passagens: ["1Cr 16,34 — ‘Dai graças ao Senhor, porque ele é bom’", "1Cr 17 — Aliança com Davi", "1Cr 29,11 — Doxologia ao Senhor"],
  ...
  "2cronicas": {
    ...
    passagens: ["2Cr 5,13-14 — Glória enche o Templo dedicado", "2Cr 7,14 — ‘Se meu povo se humilhar...’", "2Cr 36,23 — Édito de Ciro"],
  ...
  esdras: {
    ...
    passagens: ["Esd 1,2-3 — Édito de Ciro autoriza o retorno", "Esd 3,11 — Lançamento dos fundamentos do Templo", "Esd 9 — Confissão de Esdras"],
  ...
  neemias: {
    ...
    passagens: ["Ne 2,17-18 — Neemias convoca à reconstrução dos muros", "Ne 6,15 — Muro concluído em 52 dias", "Ne 8,10 — ‘A alegria do Senhor é vossa força’"],
  ...
  tobias: {
    ...
    passagens: ["Tb 4,15 — ‘Não faças a ninguém o que não queres para ti’", "Tb 8,4-8 — Oração nupcial de Tobias e Sara", "Tb 12,12 — O anjo apresenta as orações"],
  ...
  judite: {
    ...
    passagens: ["Jt 8,7-8 — Retrato da viúva piedosa e sábia", "Jt 13,18 — ‘Bendita és tu entre as mulheres’", "Jt 16,1-17 — Cântico de ação de graças"],
  ...
  ester: {
    ...
    passagens: ["Est 4,14 — ‘Quem sabe se não foi para isto que chegaste à realeza?’", "Est 4,16 — Jejum de Ester antes de interceder", "Est 9,22 — Origem da festa de Purim"],
  ...
  "1macabeus": {
    ...
    passagens: ["1Mc 2,50 — ‘Mostrai zelo pela Lei’", "1Mc 4,36-59 — Purificação do Templo", "1Mc 2,26 — Zelo de Matatias, comparado ao de Finéias"],
  ...
  "2macabeus": {
    ...
    passagens: ["2Mc 7 — Martírio dos sete irmãos macabeus", "2Mc 7,9 — Esperança na ressurreição do corpo", "2Mc 12,46 — ‘Santo pensamento orar pelos mortos’"],
  ...
  proverbios: {
    ...
    passagens: ["Pr 1,7 — ‘O temor do Senhor é o princípio da ciência’", "Pr 8,22-31 — A Sabedoria gerada antes da criação", "Pr 31,10-31 — Elogio da mulher forte"],
  ...
  cantico: {
    ...
    passagens: ["Ct 1,2 — ‘Beije-me com os beijos de sua boca’", "Ct 2,16 — ‘Meu amado é meu e eu sou dele’", "Ct 8,6 — ‘Forte como a morte é o amor’"],
  ...
  sabedoria: {
    ...
    passagens: ["Sb 3,1 — ‘As almas dos justos estão nas mãos de Deus’", "Sb 7,26 — ‘Reflexo da luz eterna’", "Sb 2,12-20 — Os ímpios perseguem o justo"],
  ...
  eclesiastico: {
    ...
    passagens: ["Eclo 1,16 — ‘Princípio da sabedoria é temer o Senhor’", "Eclo 24 — A Sabedoria habita em Israel", "Eclo 44,1 — ‘Louvemos os homens ilustres’"],
  ...
  jeremias: {
    ...
    passagens: ["Jr 1,5 — ‘Antes de te formar... eu te conheci’", "Jr 20,7-9 — Confissão: fogo nos ossos", "Jr 31,31-34 — Nova Aliança"],
  ...
  lamentacoes: {
    ...
    passagens: ["Lm 1,12 — ‘Vede se há dor igual à minha dor’", "Lm 3,22-23 — ‘As misericórdias do Senhor são novas cada manhã’", "Lm 5,21 — ‘Fazei-nos voltar a ti, Senhor’"],
    cristo: "Jesus chora sobre Jerusalém (Lc 19,41); a Igreja canta Lamentações no Tríduo Pascal.",
  },
  baruc: {
    contexto: "Livro deuterocanônico atribuído a Baruc, secretário de Jeremias, embora composto em etapas até o séc. II a.C. Reúne quatro peças de gêneros diversos: uma confissão de pecados em nome do povo exilado, um hino à Sabedoria identificada com a Lei, e a chamada ‘Carta de Jeremias’ contra a idolatria babilônica.",
    temas: ["Confissão coletiva", "Sabedoria como Lei", "Crítica da idolatria"],
    passagens: ["Br 3,38 — ‘Apareceu sobre a terra e conviveu com os homens’ (lido na Encarnação)", "Br 4,4 — ‘Feliz de nós, ó Israel, porque conhecemos o que agrada a Deus’", "Br 6 — Carta contra a idolatria"],
  ...
  ezequiel: {
    ...
    passagens: ["Ez 1 — Visão do carro divino", "Ez 36,26 — ‘Dar-vos-ei um coração novo’", "Ez 37 — Vale dos ossos secos"],
  ...
  daniel: {
    ...
    passagens: ["Dn 3 — Os três jovens na fornalha", "Dn 6 — Daniel na cova dos leões", "Dn 7,13-14 — Filho do Homem"],
  ...
  oseias: {
    ...
    passagens: ["Os 2,21-22 — Deus desposa Israel na fidelidade", "Os 6,6 — ‘Quero misericórdia e não sacrifício’", "Os 11,1 — ‘Do Egito chamei meu filho’"],
  ...
  joel: {
    ...
    passagens: ["Jl 2,12-13 — ‘Convertei-vos de todo o coração’", "Jl 2,28-29 (Jl 3,1-2) — ‘Derramarei meu Espírito sobre toda carne’", "Jl 4,14 — ‘Multidões no vale da decisão’"],
  ...
  amos: {
    ...
    temas: ["Crítica do culto sem justiça", "Opção pelos pobres", "Dia do Senhor como juízo", "Deus soberano sobre todas as nações"],
    passagens: ["Am 5,24 — ‘Corra o direito como água’", "Am 7,14-15 — Vocação de Amós, pastor chamado por Deus", "Am 8,11 — Fome da Palavra de Deus"],
  ...
  abdias: {
    ...
    passagens: ["Ab 3-4 — ‘A soberba do teu coração te enganou’", "Ab 15 — ‘O Dia do Senhor está próximo’", "Ab 21 — ‘O reino será do Senhor’"],
  ...
  jonas: {
    ...
    passagens: ["Jn 1,3 — Jonas foge para Társis", "Jn 2 — Oração no ventre do peixe", "Jn 4,11 — Compaixão de Deus por Nínive"],
  ...
  miqueias: {
    ...
    passagens: ["Mq 4,3 — Espadas transformadas em arados", "Mq 5,1 — ‘E tu, Belém-Efrata...’", "Mq 6,8 — ‘Praticar a justiça, amar a misericórdia’"],
  ...
  naum: {
    ...
    temas: ["Justiça divina sobre os impérios", "Consolo dos oprimidos", "Deus ciumento e vingador do mal"],
    passagens: ["Na 1,3 — ‘O Senhor é longânimo, mas de grande poder’", "Na 1,7 — ‘O Senhor é bom, um refúgio no dia da angústia’", "Na 2,1 — ‘Eis sobre os montes os pés do mensageiro de boas novas’"],
  ...
  habacuc: {
    ...
    passagens: ["Hab 1,2-4 — Queixa do profeta diante da violência", "Hab 2,4 — ‘O justo viverá pela fé’", "Hab 3,17-18 — ‘Eu me alegrarei no Senhor’"],
  ...
  sofonias: {
    ...
    passagens: ["Sf 1,14-15 — Anúncio do Dia do Senhor", "Sf 3,12 — ‘Deixarei no meio de ti um povo humilde’", "Sf 3,14-17 — ‘Exulta, filha de Sião’"],
  ...
  ageu: {
    ...
    temas: ["Prioridade da casa de Deus", "Glória do segundo Templo", "Confiança na providência apesar da escassez"],
    passagens: ["Ag 1,4 — ‘É tempo de habitardes em casas artesoadas...’", "Ag 2,9 — ‘A glória deste segundo Templo será maior’"],
  ...
  zacarias: {
    ...
    passagens: ["Zc 3,1-5 — Josué, o sumo sacerdote, purificado", "Zc 9,9 — ‘Eis que teu rei vem montado num jumentinho’", "Zc 12,10 — ‘Olharão para Aquele que traspassaram’"],
  ...
  malaquias: {
    ...
    passagens: ["Ml 1,11 — ‘Em todo lugar é oferecido ao meu nome um sacrifício puro’", "Ml 3,1 — ‘Eis que envio meu mensageiro’", "Ml 3,20 — ‘Nascerá o sol de justiça’"],
  ...
  "2corintios": {
    ...
    passagens: ["2Cor 4,7 — ‘Tesouro em vasos de barro’", "2Cor 5,17 — ‘Quem está em Cristo é uma nova criatura’", "2Cor 12,9 — ‘Minha graça te basta’"],
  ...
  galatas: {
    ...
    passagens: ["Gl 2,20 — ‘Vivo, mas já não sou eu, é Cristo que vive em mim’", "Gl 3,28 — ‘Não há judeu nem grego’", "Gl 5,22 — Frutos do Espírito"],
  ...
  filipenses: {
    ...
    passagens: ["Fl 1,21 — ‘Para mim, viver é Cristo’", "Fl 2,6-11 — Hino cristológico", "Fl 4,4 — ‘Alegrai-vos sempre no Senhor’"],
  ...
  colossenses: {
    ...
    passagens: ["Cl 1,15-20 — Hino cristológico", "Cl 2,9 — ‘Nele habita corporalmente a plenitude da divindade’", "Cl 3,1 — ‘Buscai as coisas do alto’"],
  ...
  "1tessalonicenses": {
    ...
    passagens: ["1Ts 1,3 — ‘Obra da fé, trabalho do amor, firmeza da esperança’", "1Ts 4,13-18 — A esperança dos que adormeceram", "1Ts 5,17 — ‘Orai sem cessar’"],
  ...
  "2tessalonicenses": {
    ...
    passagens: ["2Ts 2,3-4 — O homem da iniquidade", "2Ts 2,15 — ‘Conservai as tradições que aprendestes’", "2Ts 3,10 — ‘Quem não quer trabalhar, não coma’"],
  ...
  "1timoteo": {
    ...
    passagens: ["1Tm 2,5 — ‘Um só mediador entre Deus e os homens’", "1Tm 3 — Qualidades do bispo e do diácono", "1Tm 6,12 — ‘Combate o bom combate da fé’"],
  ...
  "2timoteo": {
    ...
    passagens: ["2Tm 1,6 — ‘Reaviva o dom de Deus que há em ti’", "2Tm 3,16 — ‘Toda Escritura é inspirada por Deus’", "2Tm 4,7 — ‘Combati o bom combate’"],
  ...
  tito: {
    ...
    passagens: ["Tt 1,5 — ‘Que estabeleças presbíteros em cada cidade’", "Tt 2,11-14 — ‘Apareceu a graça de Deus, fonte de salvação’", "Tt 3,5 — ‘Pelo banho da regeneração’"],
  ...
  filemon: {
    ...
    passagens: ["Fm 10 — Paulo intercede por Onésimo, ‘meu filho’", "Fm 16 — ‘Não mais como escravo, mas como irmão muito amado’", "Fm 17 — ‘Recebe-o como a mim mesmo’"],
  ...
  tiago: {
    ...
    passagens: ["Tg 1,27 — ‘Religião pura: visitar órfãos e viúvas’", "Tg 2,17 — ‘A fé sem obras é morta’", "Tg 5,14-15 — Fundamento bíblico da Unção dos Enfermos"],
  ...
  "1pedro": {
    ...
    passagens: ["1Pd 1,3 — ‘Regenerados para uma esperança viva’", "1Pd 2,9 — ‘Vós sois povo sacerdotal’", "1Pd 3,15 — ‘Prontos para dar razão da vossa esperança’"],
  ...
  "2pedro": {
    ...
    passagens: ["2Pd 1,4 — ‘Participantes da natureza divina’", "2Pd 1,20-21 — Sobre a Escritura", "2Pd 3,9 — ‘O Senhor não retarda a promessa’"],
  ...
  "2joao": {
    ...
    passagens: ["2Jo 6 — ‘O amor é caminhar segundo seus mandamentos’", "2Jo 7 — Aviso contra os que negam Cristo na carne"],
  ...
  "3joao": {
    ...
    passagens: ["3Jo 4 — ‘Não há alegria maior que ver meus filhos andando na verdade’", "3Jo 8 — ‘Cooperadores da verdade’"],
  ...
  judas: {
    ...
    passagens: ["Jd 3 — ‘Combatei pela fé transmitida aos santos uma vez por todas’", "Jd 9 — Disputa do arcanjo Miguel", "Jd 24-25 — Doxologia final"],
