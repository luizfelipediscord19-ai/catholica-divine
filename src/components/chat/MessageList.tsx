...
export const ChatMessageItem = memo(
  ({ message, onPerguntar, ultimaPergunta, ultimo }: ChatMessageProps) => {
    ...
    return (
      <div className={`flex animate-content-fade ${isUser ? "justify-end" : "justify-start"}`}>
        <div
...
export const MessageList = memo(
  ({ messages, isLoading, onPerguntar, ultimaPergunta }: MessageListProps) => {
