...
export function ConsentimentoLGPD() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-0 bottom-0 z-[95] print:hidden"
      data-leitura-oculto
    >
      {/* Barra compacta: nunca cobre mais que uma faixa do rodapé. */}
      {!detalhes ? (
        <div className="border-t border-gold/25 bg-card/95 shadow-[0_-8px_24px_-16px_rgba(0,0,0,0.6)] backdrop-blur-md">
          <div className="shell flex w-full flex-wrap items-center gap-x-4 gap-y-2 py-2.5">
            <p
              id="consentimento-titulo"
              className="flex min-w-0 flex-1 basis-full items-center gap-2 text-xs font-light leading-relaxed text-muted-foreground sm:basis-auto"
            >
              <ShieldCheck className="size-4 shrink-0 text-gold" aria-hidden="true" />
              <span className="min-w-0">
                Guardamos no seu aparelho só o necessário para o portal funcionar e devolver seu
                progresso.{" "}
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              <button
                ...
                className="btn-base btn-outline-gold inline-flex items-center gap-1.5 px-4 py-2 label-btn"
              >
        ...
        /* Painel de categorias: só aparece quando o leitor pede. */
        <div className="px-3 pb-3 sm:px-5 sm:pb-5">
          <div className="mx-auto max-h-[80svh] w-full max-w-[46rem] overflow-y-auto overscroll-contain rounded-2xl border border-gold/25 bg-card/95 p-4 shadow-2xl backdrop-blur-md sm:p-6">
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1 space-y-2">
                ...
                <p className="text-sm font-light leading-relaxed text-muted-foreground">
                  Você escolhe o que permitir, e pode mudar quando quiser. Detalhes na{" "}
                  <Link to="/privacidade" className="text-gold hover:underline">
