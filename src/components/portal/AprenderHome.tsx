      ...
      >
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="min-h-13 w-full surface-card py-4 pl-11 pr-4 text-base text-foreground placeholder:text-muted-foreground focus-visible:border-gold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold"
          />
        </div>
        <button
          type="submit"
