    ...
    itens: [
      {
        ...
        nota: "73 livros com texto integral e introduções",
      },
      ...
      {
        to: "/enciclopedia",
        label: "Enciclopédia Católica",
        nota: "Teologia, moral, liturgia e mariologia",
      },
  ...
  },
  {
    ...
    itens: [
      ...
      { to: "/liturgia-diaria", label: "Liturgia diária", nota: "Leituras, salmo e Evangelho" },
      {
        ...
        nota: "Bíblia, Catecismo e tema para cada dia",
      },
      {
        to: "/oracoes/diarias",
        label: "Oração diária",
        nota: "Uma oração por dia para guardar e imprimir",
      },
      {
        to: "/calendario-liturgico",
        label: "Calendário litúrgico",
        nota: "Tempos, cores e solenidades",
      },
    ],
  },
  {
    ...
    itens: [
      ...
      {
        to: "/catecismo/aulas",
        label: "Aulas de Catecismo",
        nota: "Encontros semanais com perguntas e respostas",
      },
    ],
  },
  {
    ...
    itens: [
      ...
      { to: "/forum", label: "Agora Ecclesiae", nota: "Comunidade moderada de estudo" },
      {
        to: "/testemunhos",
        label: "Testemunhos",
        nota: "Relatos reais partilhados pela comunidade",
      },
