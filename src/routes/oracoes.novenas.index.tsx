  ...
  return (
    <div>
      ...
      <Section kicker="Fundamento" title="Por que nove dias?">
        <Prose>
          <p><strong>Novena</strong> (do latim <em>novem</em>, nove) é o exercício de oração continuada por nove dias. Seu arquétipo é o Cenáculo: depois da Ascensão, os discípulos <em>“perseveravam unânimes na oração, com as mulheres, com Maria, a Mãe de Jesus, e com os irmãos dele”</em> (At 1,14), até o dia de Pentecostes. A novena é, portanto, antes de tudo <strong>escola de perseverança</strong> — a virtude que Cristo pede na parábola do amigo importuno e da viúva insistente (Lc 11,5–13; 18,1–8).</p>
