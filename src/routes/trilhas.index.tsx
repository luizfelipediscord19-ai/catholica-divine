    ...
    <div>
      ...
      <div className="shell py-block">
        ...
        {trilhaUltima && licaoUltima && (
          ...
          >
            <span>
              <span className="block kicker">Continuar estudando</span>
              <span className="mt-1 block font-display text-lg text-paper">
                {licaoUltima.titulo}
              </span>
              <span className="text-sm text-paper/65">
                {trilhaUltima.titulo} ·{" "}
                {concluidasDe(trilhaUltima.slug, trilhaUltima.licoes, progresso)}/
                {trilhaUltima.licoes.length} aulas ·{" "}
                {percentual(trilhaUltima.slug, trilhaUltima.licoes, progresso)}%
              </span>
            </span>
            ...
            return (
              ...
              >
                ...
                <p className="mt-2 flex items-center justify-between label-btn text-paper/55">
                  <span>
                    {concluidasDe(trilha.slug, trilha.licoes, progresso)}/{trilha.licoes.length}{" "}
                    aulas · {pct}%
                  </span>
